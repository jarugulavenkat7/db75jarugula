...
res.render('index', { title: 'Mobile Phone App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Mobile Phone App Registration'});
});
...
res.render('login', { title: 'Mobile Phone App Login', user : req.user });
});
